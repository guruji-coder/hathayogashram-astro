...
export const classicalTextsSchema = {
  ...
  about: [
    ...
    },
    {
      ...
      description:
        "Classical manual of Hatha Yoga covering asanas, pranayama, mudras, and samadhi",
    },
    {
      "@type": "Thing",
    ...
    },
    {
      ...
      name: "Shiva Samhita",
      description:
        "Tantric text on yoga philosophy, practices, and the nature of consciousness",
    },
  ],
  teaches: [
  ...
  teaches: [
    {
      ...
      description:
        "Single-pointed focus techniques from classical yoga tradition",
      teaches: [
    ...
    },
    {
      ...
      description:
        "Effortless flow of awareness leading to meditative absorption",
      teaches: [
    ...
    },
    {
      ...
      description:
        "Ultimate goal of yoga - union of individual and universal consciousness",
      teaches: [

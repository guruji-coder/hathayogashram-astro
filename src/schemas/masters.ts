...
export const mastersSchema = {
  ...
  "description": "Traditional yoga education following the lineage of ancient masters: Sage Vashishta, Lord Shiva (Adiyogi), and Maharishi Patanjali",
  "teaches": [
    {
      "@type": "Course",
      "name": "Yoga Vashishta Philosophy",
      "description": "Deep study of Sage Vashishta's teachings on consciousness, reality, and liberation through the Yoga Vashishta Ramayana",
      "courseCode": "YV-101",
    ...
    },
    {
      ...
      "description": "Traditional practices honoring Lord Shiva as the first yogi (Adiyogi) and source of all yogic knowledge",
      "courseCode": "SY-101",
    ...
    },
    {
      ...
      "description": "Comprehensive study of Maharishi Patanjali's Yoga Sutras and the eight-limbed path of classical yoga",
      "courseCode": "PY-101",
  ...
  "founder": [
    {
      "@type": "Person",
      "name": "Sage Vashishta",
      "description": "Ancient Vedic sage and one of the Saptarishis (seven great sages), author of Yoga Vashishta",
      "knowsAbout": [
    ...
    },
    {
      ...
      "description": "The first yogi and source of all yogic knowledge, destroyer of ignorance and transformer of consciousness",
      "knowsAbout": [
    ...
    },
    {
      ...
      "description": "Compiler of the Yoga Sutras, father of classical yoga philosophy and the eight-limbed path",
      "knowsAbout": [
...
export const classicalTextsSchema = {
  ...
  "description": "Comprehensive study of ancient yoga scriptures and their practical application in modern life",
  "author": [
    {
      "@type": "Person",
      "name": "Sage Vashishta",
  ...
  "about": [
    {
      ...
      "description": "Epic philosophical text on consciousness, reality, and spiritual liberation through dialogue between Sage Vashishta and Prince Rama"
    },
    {
      "@type": "Thing",
    ...
    },
    {
      ...
      "description": "Foundational text of classical yoga outlining the eight-limbed path to spiritual realization"
    },
    {
      "@type": "Thing",
      "name": "Shiva Samhita",
...
export const dhyanaSchema = {
  ...
  "description": "Traditional meditation practices from ancient yoga masters, focusing on dharana, dhyana, and samadhi states",
  "courseCode": "DM-101",
  "educationalLevel": "All Levels",

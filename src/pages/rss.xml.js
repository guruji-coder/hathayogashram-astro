...
export async function GET(context) {
  return rss({
    ...
    description: 'Authentic yoga teachings, philosophy, and insights from experienced masters at Hatha Yogashram, Rishikesh. Learn about traditional yoga practices, Sanskrit mantras, and spiritual development.',
    site: context.site,
    items: [
      {
        title: 'Understanding the 8 Limbs of Yoga - Patanjali\'s Ashtanga Path',
        link: '/blog/eight-limbs-of-yoga/',
        description: 'Deep dive into Patanjali\'s Yoga Sutras and the classical eight-limbed path of yoga, from ethical guidelines to ultimate spiritual realization.',
      ...
      },
      {
        ...
        description: 'Explore the classical text of Hatha Yoga, its relevance for contemporary practice, and how ancient techniques can transform your yoga journey.',
      ...
      },
      {
        ...
        description: 'Learn essential breathing techniques including Nadi Shodhana, Bhramari, and Kapalabhati. Step-by-step instructions with benefits and precautions.',
      ...
      },
      {
        ...
        description: 'Discover the power of sacred Sanskrit mantras, their meanings, pronunciation, and how they can enhance your meditation and spiritual practice.',
      ...
      },
      {
        ...
        description: 'Comprehensive guide to Ashtanga Vinyasa Yoga, its history, primary series, and how this dynamic practice can transform body and mind.',
      ...
      },
      {
        ...
        description: 'How the timeless wisdom of the Bhagavad Gita can guide us through modern challenges, with practical applications of Karma, Bhakti, and Jnana Yoga.',

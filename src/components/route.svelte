<script lang="ts">
	...
	$: movePercentage = innerWidth >= 1024 ? 100 / 3 : innerWidth >= 768 ? 100 / 2 : 100;
				...
				<div class={HOME_STYLES.CONTENT_CONTAINER}>
					...
					<div class={HOME_STYLES.COURSE_BUTTONS_CONTAINER}>
						{#each HOME_COURSES as course (course.TITLE)}
							<a href={course.URL} class="{BUTTON_STYLES.BASE} {BUTTON_STYLES.VARIANTS.PRIMARY}">
								{course.TITLE}
							</a>
						{/each}
					</div>
...
<section class="{HOME_STYLES.SECTION_PADDING} bg-yellow-50">
	<div class={HOME_STYLES.CONTAINER}>
		...
		<div class="mb-12 text-center">
			<h2 class="mb-4 text-xl font-bold text-purple-900 sm:text-2xl lg:text-3xl">
		...
		<div class="mx-auto max-w-6xl space-y-6">
			{#each OBJECTIVE_SECTION.PARAGRAPHS as paragraph (paragraph)}
				<p class="text-justify text-sm leading-relaxed text-gray-700 sm:text-base">
					{paragraph}
				</p>
			{/each}
					...
					{#each TTC_COURSES_SECTION.COURSES as course (course.TITLE)}
						...
						>
							...
							<div class="flex flex-col lg:flex-row">
								...
								<div class="relative w-full flex-shrink-0 lg:w-100">
									<img
										src={course.IMAGE}
										alt={course.TITLE}
...
<section class="{HOME_STYLES.SECTION_PADDING} bg-white">
	<div class={HOME_STYLES.CONTAINER}>
		<!-- Section Header -->
		<div class="mb-12 text-center">
			<h2 class="mb-4 text-2xl font-bold text-purple-900 sm:text-3xl lg:text-4xl">
				{CERTIFICATIONS_SECTION.TITLE}
			</h2>

			<!-- Decorative Underline SVG -->
			<div class="mb-6 flex justify-center">
				<svg width="300" height="30" viewBox="0 0 300 30" class="text-purple-900">
					<path d="M20 15 Q 150 8 280 15" stroke="currentColor" stroke-width="2" fill="none" />
					<g transform="translate(150, 15)">
						<path
							d="M-15,-8 Q-8,-12 0,-10 Q8,-12 15,-8 Q12,0 8,5 Q0,8 -8,5 Q-12,0 -15,-8 Z"
							fill="currentColor"
						/>
						<path d="M-8,-5 L-4,-1 L4,-9 L8,-5" stroke="white" stroke-width="1.5" fill="none" />
					</g>
				</svg>
			</div>
		</div>
		...
		<div class="mx-auto mb-12 max-w-4xl space-y-6">
			{#each CERTIFICATIONS_SECTION.PARAGRAPHS.slice(0, 4) as paragraph (paragraph)}
				<p class="text-justify text-base leading-relaxed text-gray-700 lg:text-lg">
					{paragraph}
				</p>
			{/each}
			...
			<div class="my-8 flex justify-center">
				<div class="h-full w-full transition-transform duration-300 hover:scale-105">
					<img
...
<section class="relative flex min-h-screen items-center justify-center overflow-hidden py-16">
	...
	<div class="relative z-10 container mx-auto px-4 text-center text-white">
		...
		<!-- Subtitle -->
		<h3 class="mb-8 text-xl font-semibold text-yellow-300 sm:text-2xl lg:text-3xl">
		...
		<div class="mx-auto mb-12 max-w-4xl space-y-6">
			<p class="text-base leading-relaxed lg:text-lg">
				Hatha Yoga Ashram in Rishikesh offers a comprehensive certification for becoming an
				International Yoga Instructor for 100-hour, 200-hour, 300-hour, 500-hour YTTC courses along
				with short courses like Yin Yoga TTC, Prenatal YTTC, Sound Healing, Reiki Healing, Ayurveda
				and Aerial Yoga YTTC. Yoga Alliance, USA, recognizes us as we ensure higher and better
				education and training standards in Yoga.
			</p>
			<p class="text-base leading-relaxed lg:text-lg">
				Graduates from our Yoga School receive this certification, which marks their credibility and
				makes them eligible to teach worldwide. It opens great career opportunities for students and
				also fosters a global community of well-trained yoga practitioners who are appreciated for
				their work.
			</p>
		</div>
...
<section class="{HOME_STYLES.SECTION_PADDING} bg-white">
	<div class={HOME_STYLES.CONTAINER}>
		<!-- Section Header -->
		<div class="mb-12 text-center">
			<h2 class="mb-6 text-2xl font-bold text-purple-900 sm:text-3xl lg:text-4xl">
		...
		<div class="mx-auto max-w-6xl">
			...
			<div class="mt-8 flex justify-center space-x-3">
				{#each TEACHERS_SECTION.TEACHERS as _, index (_)}
					<div
						class="h-3 w-3 rounded-full transition-colors {index === currentTeacher
							? 'bg-orange-500'
							: 'bg-gray-300'}"
					></div>
				{/each}
		...
		<div class="mt-12 text-center">
			<a
				href="/enroll"
				class="{BUTTON_STYLES.BASE} {BUTTON_STYLES.VARIANTS.PRIMARY} px-8 py-4 text-lg"
			>
				Enroll Now
			</a>
		</div>
...
<section class="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50">
	...
	<section class="py-20">
		<div class="container mx-auto px-4 text-center">
			<h1 class="mb-4 font-space text-3xl font-bold text-purple-900 sm:text-4xl">
...
<section class="bg-gray-50 bg-gradient-to-br from-purple-100 to-purple-50 py-16">
	<div class="container mx-auto px-4">
		<!-- Section Header -->
		<div class="mb-16 text-center">
			<h2 class="mb-4 text-center text-3xl font-bold text-purple-900 md:text-4xl">

/**
 * Comprehensive asana (yoga pose) keywords
 * Organized by categories for maximum SEO impact
 */

export const ASANA_KEYWORDS = {
  // Standing Asanas
  standingAsanas: [
  ...
  restorativeAsanas: [
    ...
    "viparita karani legs up the wall",
    "supported setu bandhasana supported bridge",
...
/**
 * Asana sequences for SEO and content
 */
export const ASANA_SEQUENCES = {
  "Sun Salutation A": [
    "Tadasana (Mountain Pose)",
...
/**
 * Asana difficulty levels and progression paths
 */
export const ASANA_PROGRESSION = {
  "Beginner Level": [
    "Tadasana (Mountain Pose)",
    "Balasana (Child's Pose)",
    "Sukhasana (Easy Pose)",

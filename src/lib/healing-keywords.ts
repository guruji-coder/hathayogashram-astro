...
export const CONDITION_ASANA_MAP = {
  "Back Pain": ["Child's Pose", "Cat-Cow", "Bridge Pose", "Sphinx Pose", "Supine Twist"],
  "Anxiety": ["Legs-Up-Wall", "Child's Pose", "Forward Fold", "Corpse Pose", "Butterfly"],
  "Depression": ["Bridge Pose", "Camel Pose", "Warrior I", "Tree Pose", "Sun Salutation"],
  "Insomnia": ["Legs-Up-Wall", "Forward Fold", "Supine Twist", "Happy Baby", "Corpse Pose"],
  "Diabetes": ["Spinal Twist", "Bow Pose", "Plough Pose", "Fish Pose", "Camel Pose"],
  "High Blood Pressure": ["Child's Pose", "Legs-Up-Wall", "Corpse Pose", "Bridge Pose", "Forward Fold"],
  "Digestive Issues": ["Spinal Twist", "Wind Relieving", "Bow Pose", "Cobra", "Cat-Cow"],
  "Thyroid": ["Bridge Pose", "Fish Pose", "Shoulder Stand", "Plough Pose", "Camel Pose"],
  "Sciatica": ["Pigeon Pose", "Figure Four Stretch", "Cat-Cow", "Cobra", "Child's Pose"],
  "Menstrual Cramps": ["Child's Pose", "Reclining Bound Angle", "Supine Twist", "Cat-Cow", "Legs-Up-Wall"],
  "Arthritis": ["Mountain Pose", "Warrior II", "Extended Triangle", "Cat-Cow", "Chair Pose"],
  "Asthma": ["Bridge Pose", "Cobra Pose", "Fish Pose", "Camel Pose", "Bow Pose"],
  "Headaches": ["Child's Pose", "Downward Dog", "Bridge Pose", "Legs-Up-Wall", "Seated Forward Fold"],
  "IBS": ["Wind Relieving Pose", "Cat-Cow", "Spinal Twist", "Child's Pose", "Corpse Pose"],
  "Chronic Fatigue": ["Legs-Up-Wall", "Supported Bridge", "Reclining Bound Angle", "Child's Pose", "Corpse Pose"]
};
...
export const HEALING_SOLUTIONS = {
  "Chronic Back Pain": {
    ...
    solution: "Specific yoga sequences strengthen core, improve flexibility, and realign spine",
  ...
  "Anxiety & Depression": {
    ...
    solution: "Yoga regulates nervous system, balances neurotransmitters, promotes mindfulness",
  ...
  "Insomnia": {
    ...
    solution: "Evening yoga routine calms mind, releases tension, prepares body for rest",
  ...
  "Type 2 Diabetes": {
    ...
    solution: "Yoga improves insulin sensitivity, reduces blood sugar levels, and promotes weight management",
  ...
  "Hypertension": {
    ...
    solution: "Restorative yoga and slow breathing techniques reduce blood pressure naturally",

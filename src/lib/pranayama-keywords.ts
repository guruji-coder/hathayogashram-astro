...
export const PRANAYAMA_TECHNIQUES = {
  "Nadi Shodhana": {
    ...
    description:
      "Balances the left and right hemispheres of the brain, calms the nervous system",
    benefits: [
      "Reduces anxiety",
      "Balances hormones",
      "Improves focus",
  ...
  Ujjayi: {
    ...
    description:
      "Ocean-sounding breath created by slight constriction of the throat",
    benefits: [
      "Increases oxygen",
  ...
  Kapalabhati: {
    ...
    description:
      "Forceful exhalations and passive inhalations to energize and cleanse",
    benefits: [
      "Detoxifies lungs",
  ...
  Bhramari: {
    ...
    description:
      "Creating a humming sound during exhalation while ears are covered",
    benefits: [
  ...
  Shitali: {
    ...
    description:
      "Inhalation through a rolled tongue, followed by normal exhalation",
    benefits: [
    ...
    keywords: [
      ...
      "shitali pranayama",
      "summer breathing practice",
      "tongue rolling breath",
    ],
  },
};

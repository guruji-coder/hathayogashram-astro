...
export const SEO_PATTERNS = {
  ...
  titlePatterns: {
    ...
    courses:
      "{courseName} | {duration} Hour Yoga Teacher Training | {siteName}",
    healing:
      "Yoga for {condition}: Natural Healing with Ancient Techniques | {siteName}",
    asana:
      "{sanskritName} ({englishName}): Benefits, Technique & Variations | {siteName}",
    pranayama:
      "{sanskritName} Breathing: Benefits & Step-by-Step Guide | {siteName}",
  },

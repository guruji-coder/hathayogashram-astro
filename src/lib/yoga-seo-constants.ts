...
export const SEO_PATTERNS = {
  ...
  descriptionPatterns: {
    ...
    courses: "Join our {duration}-hour {courseName} at {siteName}, Rishikesh. Authentic training with experienced teachers. Yoga Alliance certified courses. Apply now!",
    healing: "Discover how yoga can help with {condition}. Evidence-based yoga poses, breathing techniques and meditation practices for natural healing.",
    asana: "Learn {sanskritName} ({englishName}) with proper alignment, benefits, contraindications and variations. Step-by-step guide for yoga practitioners.",
    pranayama: "Master {sanskritName} breathing technique for {benefit}. Learn correct technique, benefits and precautions in this comprehensive guide."
  },
...
export const SITE_METADATA = {
  ...
  defaultDescription: "Experience authentic yoga at Hatha Yogashram, a traditional yoga school in Rishikesh, India. Join our yoga teacher training courses, retreats and workshops.",

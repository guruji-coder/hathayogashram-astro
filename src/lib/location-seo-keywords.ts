/**
 * Location-based SEO keywords for targeting international students
 */

export const LOCATION_KEYWORDS = {
  // Target countries with high yoga interest
  countrySpecific: {
    usa: [
      "yoga teacher training india for americans",
  ...
  // Comparison searches
  comparisons: [
    "rishikesh vs goa yoga teacher training",
    "india vs bali yoga certification",
    "rishikesh vs kerala yoga ttc",
    "best yoga school rishikesh vs dharamshala",
    "affordable yoga ttc india vs thailand",
    "authentic yoga training india vs usa",
  ...
  budgetKeywords: [
    ...
    "affordable yoga ttc rishikesh",
    "budget yoga certification india",
    "low cost yoga teacher training",
    "economical yoga course india",
    "value for money yoga ttc",
...
export const COMPETITOR_KEYWORDS = {
  ...
  schoolComparisons: [
    "parmarth niketan vs hatha yogashram",
    "rishikesh yogpeeth alternative",
    "better than yoga vidya mandiram",
    "hatha yogashram reviews",
    "best yoga school rishikesh 2025",
    "top rated yoga ttc rishikesh",
  ...
  // Style comparisons
  styleComparisons: [
    "hatha vs vinyasa teacher training",
    "traditional vs modern yoga ttc",
    "ashtanga vs hatha certification",
    "classical vs contemporary yoga",
    "authentic indian vs western yoga",
    "spiritual vs fitness yoga training",
...
export const COURSE_SPECIFIC_KEYWORDS = {
  ...
  certificationQueries: [
    "yoga alliance rys 200 india",
    "yoga alliance rys 300 india",
    "yoga alliance continuing education",
    "internationally recognized yoga certification",
    "yoga certificate apostille india",
    "government recognized yoga course india",
  ...
  // Student concerns
  studentConcerns: [
    "yoga teacher training for beginners india",
    "no experience yoga teacher training",
    "yoga ttc for older students",
    "yoga teacher training over 40",
    "yoga ttc for men india",
    "solo female yoga training india safe",
  ...
  programFeatures: [
    "small group yoga teacher training",
    "personalized yoga ttc india",
    "yoga teacher training with job placement",
    "yoga ttc with teaching practice",
    "yoga training with karma yoga",
    "yoga ttc with ayurveda included",

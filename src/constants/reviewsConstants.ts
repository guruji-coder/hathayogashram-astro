export const REVIEWS_SECTION = {
  ...
  VIEW_ALL_URL:
    "https://www.google.com/search?q=hatha+yoga+ashram+rishikesh+reviews",
...
export const REVIEWS_STYLES = {
  ...
  REVIEWER_IMAGE:
    "w-16 h-16 rounded-full object-cover mr-4 border-4 border-orange-200",
  ...
  READ_MORE:
    "text-orange-500 hover:text-orange-600 font-medium transition-colors",
  VIEW_ALL_BUTTON:

...
export const YOGA_GURUS_STYLES = {
	...
	CARDS_CONTAINER: 'flex snap-x snap-mandatory gap-6 overflow-x-auto scroll-smooth pt-12 pb-4',
	
	// Spiritual Card Styles
	SPIRITUAL_CARD: 'w-[calc(100%-12px)] md:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] flex-shrink-0 snap-start px-6 transition-all duration-300 hover:scale-105 rounded-3xl',
	
	// Profile image styles - bigger sizes
	PROFILE_CONTAINER: 'mb-6 flex justify-center',
	PROFILE_IMAGE_WRAPPER: 'w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 overflow-hidden rounded-full',
	PROFILE_IMAGE: 'h-full w-full rounded-full object-cover transition-transform duration-500 hover:scale-110',
	...
	INDICATOR: 'w-3 h-3 rounded-full bg-purple-300 transition-all duration-300 hover:bg-purple-500 cursor-pointer',

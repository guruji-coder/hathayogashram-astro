...
export const HOME_STYLES = {
  ...
  CERTIFICATION_PARAGRAPH:
    "text-justify leading-relaxed text-gray-700 font-medium",
  ...
  COURSE_BUTTONS_CONTAINER:
    "flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mt-6 sm:mt-8",
} as const;
...
export const TEACHERS_SECTION = {
  ...
  DID_YOU_KNOW:
    "The core teachers at Hatha Yoga Ashram are international asana champions!",
  ...
  TEACHERS: [
    {
      ...
      description:
        "Master in traditional Ashtanga Yoga and precise alignment techniques.",
    },
    {
      id: 2,
      name: "Ravi Bisht",
      ...
      description:
        "Expert in traditional Hatha Yoga practices and ancient techniques.",
    },
    {
      id: 3,
      ...
      description:
        "Specialist in meditation practices and breathing techniques.",
    },
    {
      id: 4,
      name: "Shivam Rawat",

...
export const BUTTON_STYLES = {
	...
	VARIANTS: {
		PRIMARY: 'text-white bg-purple-900 border-purple-900 hover:bg-white hover:text-purple-900 hover:border-purple-900 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 text-xs',
		SECONDARY: 'bg-white text-purple-900 border-purple-900 hover:bg-purple-50 hover:border-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 text-sm'
	}
} as const;
